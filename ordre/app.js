...
(function () {
  ...
  /* ── رموز الولايات (للشحن) ─────────────────────────────
     المصدر الموحّد: js/delivery-pricing.js (يُحمَّل قبل هذا الملف) */
  ...
  /* ── عمولة موظفة متابعة الطلبيات (وكيلة الطلبات) ──────────
     ...
     وليس عدد المنتجات المختلفة) — لا علاقة لها بالإلكترونيات.
     0 كتاب = 0 دج. 1 كتاب = 100 دج. كل نسخة إضافية
  ...
  /* رقم التواصل المعروض هنا هو رقم العمل المركزي (site_settings.business_phone
     ...
     الافتراضي كنسخة احتياطية إذا لم يُحمَّل business-contact.js بعد. */
