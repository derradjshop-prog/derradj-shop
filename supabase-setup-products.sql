...
INSERT INTO public.product_availability (catalog_id, name, available) VALUES
  ...
  (33, 'العادات السبع للمراهقين الأكثر فعالية',                  true),
  (34, 'القائد في داخلي',                                        true),
  (35, 'الأنوثة المظلمة',                                        true),
  (36, 'لماذا لا تذهب الخراف إلى الطبيب؟',                       true),
  (37, 'من صفر إلى واحد',                                        true),
  (38, 'اللطف وآثاره الجانبية الخمسة',                           true),
  (39, 'طاقة الأنوثة',                                           true),
  (40, 'ممتلئ بالفراغ',                                          true),
  (41, 'أبي الذي أكره',                                          true),
  (42, 'بلورة الرأي العام',                                      true)
